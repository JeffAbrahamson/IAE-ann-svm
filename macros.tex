...
\newenvironment{soln}{\purple{\textit{Solution.}}}{\purple{\textit{solution/}}}
...
\newcommand\pr[0]{\mathbf{Pr}}
\newcommand\R[0]{\mathbb{R}}

% Only useful in reflowable.
\newcommand\notesection[1]{\bigskip{\textbf{\large #1}}}
...
\newcommand\notetitle[2]{\vspace{10mm}\centerline{\Large #1}\vspace{2mm}}
...
\newcommand\exercise[1]{\bigskip\centerline{\fbox{\parbox{.8\textwidth}{\textbf{Exercise:} #1}}}}